...
namespace ProtoLib.Migrations
{
    ...
    [Migration("20240614120757_prodLineLast")]
    partial class prodLineLast
    {
            ...
            modelBuilder.Entity("ProtoLib.Model.DailySource", b =>
                {
                    ...
                    b.Property<string>("ProdutLineId")
                        .HasColumnType("nvarchar(32)");
            ...
            modelBuilder.Entity("ProtoLib.Model.DailySource", b =>
                {
                    ...
                    b.HasOne("ProtoLib.Model.ProductionLine", "ProdutLine")
                        .WithMany()
                        .HasForeignKey("ProdutLineId");

                    b.Navigation("Post");

                    b.Navigation("ProdutLine");
                });
